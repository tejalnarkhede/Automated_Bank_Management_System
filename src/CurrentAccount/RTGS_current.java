...
public class RTGS_current extends TestCurrent{
void printRTGS() {
	Scanner sc=new Scanner(System.in);
	System.out.println("\n\t\t\t=========****** WELCOME TO FUND TRANSFER BY RTGS ******=========\n");
	 LocalTime just= LocalTime.now();
		...
		if(LateRTGS== true &&  beforeRTGS==true) {
			System.out.println("\n\t\t Your balance in current account is:"+t.getBalance());
			   ...
			   if(transfer_amount>=200000 && transfer_amount<=1000000) 
			   {
				...
				//   System.out.println("\n\t\t Yess!!You can transfer...");
				   ...
				   System.out.println("sorry!!you cannot transfer");
					...
					System.out.println("\n\t\tcurrent account balance after withdraw:"+t.getBalance());
	}
			 }catch(Exception e) {
