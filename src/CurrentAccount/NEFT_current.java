...
import CurrentAccount.Current_Account;
//import Saving_Account.SavingAccount;
import java.time.LocalTime;
import java.util.Scanner;
public class NEFT_current extends TestCurrent {
		...
		//System.out.println("\n\t\t***************************************************************");
		   ...
		   LocalTime now = LocalTime.now();
			...
			if( LateNEFT== true && beforeNEFT==true) {
			    ...
			    System.out.println("\n\t\tNow Balance in current account is:"+t.getBalance());
			    //System.out.println();
		    ...
		    //	e.withdraw(transfer_amount);
				...
				try {
				   ...
				   System.out.println("\n\t\tSorry!!you cannot transfer");
					...
					//SavingAccount s=new SavingAccount();
					//s.getBalance();
					t.withdraw(final_amount);
					System.out.println("\n\t\tYou transferred "+transfer_amount+" Successfully..!!!");
					
					System.out.println("\n\t\tNow current account balance is after withdraw:"+t.getBalance());
				}
